...
对应的流程图如下（**注意：今日首次访问图中有错误左右条件画反了**）
...
### 2. 小结
 ...
 1. 本文可以说是redis学习之后，一个挺好的应用场景，涉及到了我们常用和不常用的几个数据结构，包括hash,zset;
 2. 原文作者在存储每日pv访问记录的时候使用的是bitmap分段存储，会有问题，所以我改变使用hash存储
 3. 本文统计访问数据时使用的异步策略
 4. 设置定时任务同步每天访问量到mysql数据库做持久化，分布式定时任务可以使用zookeeper选举机制，master节点执行任务
...
- 工程：[raychou-visitsitecount](https://github.com/RayChouGitHub/raychou-visitsitecount)

### 2. 声明

 1. 尽信书则不如，以上内容，纯属一家之言，因个人能力有限，难免有疏漏和错误之处，如发现bug或者有更好的建议，欢迎批评指正，不吝感激
 2. 源码工程来源于：一灰灰的个人博客，记录所有学习和工作中的博文，欢迎大家前去逛逛，笔者只是部分修改整合项目启动部分，同步redis数据到mysql做持久化处理
 3. 原文链接：[https://juejin.im/post/5cdad0dc6fb9a0322f7cad73](https://juejin.im/post/5cdad0dc6fb9a0322f7cad73)
 4. 原文github地址：[https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-case/124-redis-sitecount](https://github.com/liuyueyi/spring-boot-demo/tree/master/spring-case/124-redis-sitecount)
 
### 3.欢迎各位大神朋友一起学习交流经验
![enter image description here](https://lh3.googleusercontent.com/vhtyVyYsVRf3K3m9U5hy3h1W0ET0-dyKejQf2NrKWZnztbYCshUnhSGFFNUS3bkiSJ02M5G1W2Y)

### 4.打赏笔者
![enter image description here](https://lh3.googleusercontent.com/Y_kAEGFCiXaUysljcCIWM1ZS6BLPWZzE4oO3r3rWPYMJrhJ12RJwbuPG0j_IpXKqL4FYje1HLFs)![enter image description here](https://lh3.googleusercontent.com/Tka6ucDZIklTJ8NSCtMIEbTS-ZTdSem6Gm1s9cPBdJ9FN8LlMWjc2bgS-Tkk2yWQAwgN9PDf67Q)