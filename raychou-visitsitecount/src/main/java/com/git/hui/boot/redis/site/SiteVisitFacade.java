...
public class SiteVisitFacade {
    ...
    private String buildUriTagKey(String app, String uri) {
        return "pv_uri_tag_" + DateUtil.getToday() + "_" + app + "_" + uri;
    }
     ...
     */
    @Async
    public Future<SiteVisitDTO> visit(VisitReqDTO reqDTO) {
        ...
        return new AsyncResult<>(new SiteVisitDTO(siteVisit, uriVisit));
    }
